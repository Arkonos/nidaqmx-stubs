...
class DigitalMultiChannelWriter(ChannelWriterBase):
    ...
    def write_one_sample_one_line(self, data: ndarray, timeout: float = 10) -> None: ...
    def write_one_sample_port_byte(
        self, data: ndarray, timeout: float = 10
    ) -> None: ...
    def write_one_sample_port_uint16(
        self, data: ndarray, timeout: float = 10
    ) -> None: ...
    def write_one_sample_port_uint32(
        self, data: ndarray, timeout: float = 10
    ) -> None: ...
